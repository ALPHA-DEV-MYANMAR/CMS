          ...
          <div class="row">
            <div class="col-lg-3 col-md-4 col-sm-12">
              <div class="faq-navigation d-flex justify-content-between flex-column mb-2 mb-md-0">
                ...
                <!-- FAQ image -->
                <img src="https://ooak.jp/admin-template/app-assets/images/illustration/faq-illustrations.svg" class="img-fluid d-none d-md-block" alt="demand img">
              </div>
            </div>
              ...
              <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane active" id="faq-payment" aria-labelledby="payment" aria-expanded="true">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <h4 class="mb-0">Return and Refund Policy </h4>
                    ...
                    <div class="card accordion-item">
                      <h2 class="accordion-header">
                        <button class="accordion-button">
                          Return လုပ်လိုရင် ပစ်စည်း ရောက်တဲ့နေ့ကစပြီး ၄ ရက်အတွင်း OOAK Facebook Messenger မှ
                          Order Number ပြောပြီး၊ Return လုပ်လိုသည့် အကြောင်းပြချက် ကို ပို့ပေးပါ။
                        </button>
                      </h2>
                    </div>
                    <div class="card accordion-item">
                      <h2 class="accordion-header">
                        <button class="accordion-button">
                          OOAK ချို့ယွင်းမှုကြောင့် ဖြစ်ပါက Return ပြန်ပို့ခ အခမဲ့ ဖြစ်ပါသည်။
                        </button>
                      </h2>
                    </div>
                    <div class="card accordion-item">
                      <h2 class="accordion-header">
                        <button class="accordion-button">
                          ဝယ်ယူသူ ရဲ့ ချို့ယွင်းမှုကြောင့်ဆိုပါက ပို့ခကို ဝယ်ယူသူမှ ကျခံပေးရပါမည်။ အခြားနေရာမှ ဝယ်ယူထားသော ပစ္စည်း ဖြင့် လဲလှယ်ပြီး Return လုပ်ပါက ဂျပန်နိင်ငံရဲ့ တရားဥပဒေအတိုင်း တရားစွဲဆိုမည် ဖြစ်သောကြောင့် မပြုလုပ်ခြင်းဖြင့် ပူပေါင်းကူညီပေးပါ။
                        </button>
                      </h2>
                    </div>
                    <div class="card accordion-item">
                      <h2 class="accordion-header">
                        <button class="accordion-button">
                          Return လုပ်သော ပစ်စည်းရောက်ပါက စစ်ဆေးပြီး၊ ၇ ရက်အတွင်း ငွေပြန်လွှဲပေးပါမည်။ COD နည်းလမ်းဖြင့် ငွေပေးချေသူများအတွက် Return လုပ်တဲ့အခါ COD ဝန်ဆောင်ခ ပြန်ပါမည်မဟုတ်ပါ။ BANK TRANSFER ဖြင့် ငွေပေးချေသူများအတွက် ငွေလွှဲခ နှုတ်ပြီး ပြန်လွှဲပေးပါမည်။
                        </button>
                      </h2>
                    </div>
                    <div class="card accordion-item">
                      <h2 class="accordion-header">
                        <button class="accordion-button">
                          ၄ ရက်ထက် ကျော်လွန်ပြီးမှ ဆက်သွယ်လာပါက Return လုပ်နိင်တဲ့အချိန်ကျော်လွန်သွားသောကြောင့် Return လုပ်လို့မရနိင်ပါသဖြင့် သတ်မှတ်ရက်အတွင်း ဆက်သွယ်ပေးရန် သတိပြုပေးပါ။
                        </button>
                      </h2>
                    </div>
                ...
                <div class="tab-pane" id="faq-cancellation-return" role="tabpanel" aria-labelledby="cancellation-return" aria-expanded="false">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="avatar avatar-tag bg-light-primary me-1">
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-refresh-cw font-medium-4"><polyline points="23 4 23 10 17 10"></polyline><polyline points="1 20 1 14 7 14"></polyline><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"></path></svg>
                    </div>
                    <div>
                  ...
                  <div class="accordion accordion-margin mt-2" id="faq-cancellation-qna">
                    ...
                    <div class="card accordion-item">
                      <h2 class="accordion-header" id="cancellationThree">
                        <button class="accordion-button collapsed" data-bs-toggle="collapse" role="button" data-bs-target="#faq-cancellation-three" aria-expanded="false" aria-controls="faq-cancellation-three">
                          How can I cancel my shipment?
                        </button>
                      </h2>
                      <div id="faq-cancellation-three" class="collapse" aria-labelledby="cancellationThree" data-bs-parent="#faq-cancellation-qna">
                        <div class="accordion-body">
                          Tart gummies dragée lollipop fruitcake pastry oat cake. Cookie jelly jelly macaroon icing jelly beans
                          soufflé cake sweet. Macaroon sesame snaps cheesecake tart cake sugar plum. Dessert jelly-o sweet
                          muffin chocolate candy pie tootsie roll marzipan. Carrot cake marshmallow pastry. Bonbon biscuit
                    ...
                    <div class="card accordion-item">
                      <h2 class="accordion-header" id="cancellationFour">
                        <button class="accordion-button collapsed" data-bs-toggle="collapse" role="button" data-bs-target="#faq-cancellation-four" aria-expanded="false" aria-controls="faq-cancellation-four">
                          I have received a defective/damaged product. What do I do?
                        </button>
                      </h2>
                      <div id="faq-cancellation-four" class="collapse" aria-labelledby="cancellationFour" data-bs-parent="#faq-cancellation-qna">
                        <div class="accordion-body">
                          Cheesecake muffin cupcake dragée lemon drops tiramisu cake gummies chocolate cake. Marshmallow tart
                          croissant. Tart dessert tiramisu marzipan lollipop lemon drops. Cake bonbon bonbon gummi bears topping
                          jelly beans brownie jujubes muffin. Donut croissant jelly-o cake marzipan. Liquorice marzipan cookie
                    ...
                    <div class="card accordion-item">
                      <h2 class="accordion-header" id="cancellationFive">
                        <button class="accordion-button collapsed" data-bs-toggle="collapse" role="button" data-bs-target="#faq-cancellation-five" aria-expanded="false" aria-controls="faq-cancellation-five">
                          How do I change my delivery address?
                        </button>
                      </h2>
                      <div id="faq-cancellation-five" class="collapse" aria-labelledby="cancellationFive" data-bs-parent="#faq-cancellation-qna">
                        <div class="accordion-body">
                          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
                          dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
                          aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
                    ...
                    <div class="card accordion-item">
                      <h2 class="accordion-header" id="cancellationSix">
                        <button class="accordion-button collapsed" data-bs-toggle="collapse" role="button" data-bs-target="#faq-cancellation-six" aria-expanded="false" aria-controls="faq-cancellation-six">
                          What documents do I need to carry for self-collection of my shipment?
                        </button>
                      </h2>
                      <div id="faq-cancellation-six" class="collapse" aria-labelledby="cancellationSix" data-bs-parent="#faq-cancellation-qna">
                        <div class="accordion-body">
                    ...
                    <div class="card accordion-item">
                      <h2 class="accordion-header" id="cancellationSeven">
                        <button class="accordion-button collapsed" data-bs-toggle="collapse" role="button" data-bs-target="#faq-cancellation-seven" aria-expanded="false" aria-controls="faq-cancellation-seven">
                          What are the timings for self-collecting shipments from the Delhivery Branch?
                        </button>
                      </h2>
                      <div id="faq-cancellation-seven" class="collapse" aria-labelledby="cancellationSeven" data-bs-parent="#faq-cancellation-qna">
                        <div class="accordion-body">
                          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
        ...
        <section class="faq-contact">
          <div class="row mt-5 pt-75">
            <div class="col-12 text-center">
              ...
              <p class="mb-3">
                If you cannot find a question in our policy, you can always contact us. We will answer to you shortly!
              </p>
            </div>
            <div class="col-sm-6">
