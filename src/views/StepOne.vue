  ...
  <div class="col-md-12 text-start ">
    <div class="container-fluid">
      ...
      <div style="height: 100%;display: flex;align-items: center;justify-content: center;">
        <img src="https://ooak.jp/images/OOAK Logo (final)-02 (1).png" alt="" width="200" height="200">
      </div>

      <h2 class="text-center ">OOAKAPP PRIVACY POLICY</h2>
      <h3 class="text-center">[OOAK MOBILE APP]</h3>
      <p class="text-center" style="color:gray">Last update[ 14 November 2021]</p>

      <div>
        <p>
          <span style="font-weight: bold">OOAK </span> , we respects the privacy of our users .This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our mobile application (the “Application”).   Please read this Privacy Policy carefully.  IF YOU DO NOT AGREE WITH THE TERMS OF THIS PRIVACY POLICY, PLEASE DO NOT ACCESS THE APPLICATION.
        </p>
        <p>
        ...
        <div>
          ...
          <h6>Data from Social Networks </h6>
          <p>
        ...
        <div>
          ...
          <p>
            f you interact with other users of the Application, those users may see your name, profile photo, and descriptions of your activity, including sending invitations to other users, chatting with other users, liking posts, following blogs.
          </p>
          <h6>
            Online Postings
          </h6>
        ...
        <div>
          ...
          <p>
            Additionally, we may use third-party software to serve ads on the Application, implement email marketing campaigns, and manage other interactive marketing initiatives.  This third-party software may use cookies or similar tracking technology to help manage and optimize your online experience with us.  For more information about opting-out of interest-based ads, visit the <span style=" text-decoration: underline;">Network Advertising Initiative Opt-Out Tool or Digital Advertising Alliance Opt-Out Tool.<span>
            </span></span></p>
          <h6>
            Website Analytics
          </h6>
          <p>
            We may also partner with selected third-party vendors[, such as <span style=" text-decoration: underline;">[Adobe Analytics,] </span> <span style=" text-decoration: underline;">[Clicktale,]</span> <span style=" text-decoration: underline;"> [Clicky,] </span> <span style=" text-decoration: underline;">[Cloudfare,]</span> <span style=" text-decoration: underline;"> [Crazy Egg,]</span> <span style=" text-decoration: underline;"> [Flurry Analytics,]</span> <span style=" text-decoration: underline;"> [Google Analytics,]</span> <span style=" text-decoration: underline;"> [Heap Analytics,] </span> <span style=" text-decoration: underline;">[Inspectlet,]</span> <span style=" text-decoration: underline;"> [Kissmetrics,]</span> <span style=" text-decoration: underline;"> [Mixpanel,]</span> <span style=" text-decoration: underline;"> [Piwik,]</span> and others], to allow tracking technologies and remarketing services on the Application through the use of first party cookies and third-party cookies, to, among other things, analyze and track users’ use of the Application, determine the popularity of certain content, and better understand online activity. By accessing the Application, you consent to the collection and use of your information by these third-party vendors. You are encouraged to review their privacy policy and contact them directly for responses to your questions. We do not transfer personal information to these third-party vendors. However, if you do not want any information to be collected and used by tracking technologies, you can install and/or update your settings for one of the following:
          </p>
          <ul>
        ...
        <div>
          ...
          <ul>
            <li style="list-style: none">
              [Company Name] – OOAK Company Ltd.
            </li>
            <li style="list-style: none">
              [Street Address] – sakae 4-1-5 aaa Bld 401
            </li>
            <li style="list-style: none">
              [Street Address] – sakae 4-1-5 aaa Bld 401
            </li>
            <li style="list-style: none">
              [City, State Zip] – Japan , Aichi-ken, Ichinomiya-shi
            </li>
            <li style="list-style: none">
              [Phone Number] – 070-4061-4157
            </li>
            <li style="list-style: none">
              [Email] – info@ooak.jp
            </li>
