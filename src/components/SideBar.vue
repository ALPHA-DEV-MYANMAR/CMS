<template>
  <div class="aiz-user-sidenav-wrap position-relative z-1 shadow-sm">
    ...
    >
      <div
          class="p-4 text-xl-center mb-4 border-bottom bg-primary text-white position-relative"
      >
        ...
        <h4 class="h5 fs-16 mb-1 fw-600">Alpha</h4>
        <div class="text-truncate opacity-60">alpha@gmail.com</div>
      </div>

      <div class="sidemnenu mb-3">
        <ul
            class="aiz-side-nav-list px-2 metismenu"
            data-toggle="aiz-side-menu"
        >
          <li class="aiz-side-nav-item mm-active">
            <router-link
                to="/profile"
                class="aiz-side-nav-link nav-link active"
                aria-expanded="true"
            >
          ...
          <li class="aiz-side-nav-item">
            <router-link
                to="/wishlist"
                class="aiz-side-nav-link nav-link"
            >
      ...
      <div class="widget-balance pb-3 pt-1">
        <div class="text-center">
          <div class="heading-4 strong-700 mb-4">
            <small class="d-block fs-12 mb-2"
            >Your sold amount (current month)</small
            >
            <span class="btn btn-primary fw-600 fs-18">$0.00</span>
          </div>
          <table class="table table-borderless">
            <tbody>
            <tr>
              <td class="p-1" width="60%">Total Sold:</td>
              <td class="p-1 fw-600" width="40%">$0.00</td>
            </tr>
            <tr>
              <td class="p-1" width="60%">Last Month Sold:</td>
              <td class="p-1 fw-600" width="40%">$0.00</td>
            </tr>
            </tbody>
          </table>
    ...
    <div
        class="fixed-bottom d-xl-none bg-white border-top d-flex justify-content-between px-2"
        style="box-shadow: 0 -5px 10px rgb(0 0 0 / 10%)"
    >
      <router-link
          class="btn btn-sm p-2 d-flex align-items-center nav-link"
          to=""
      >
